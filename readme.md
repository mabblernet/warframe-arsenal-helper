...
`https://YOUR_USERNAME.github.io/YOUR_GITHUB_PROJECT_NAME/`
...
The weapon data lives entirely in `warframe-arsenal.html`. Each weapon entry looks like this:
